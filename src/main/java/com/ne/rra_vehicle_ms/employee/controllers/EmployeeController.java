...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> createEmployee(@Valid @RequestBody EmployeeRequestDto employee) {
    ...
    @PreAuthorize("hasRole('MANAGER')")
    public ResponseEntity<Employee> updateEmployeeStatus(@PathVariable UUID id, @RequestParam EmployeeStatus status) {
    ...
    @PreAuthorize("hasRole('MANAGER')")
    public ResponseEntity<Employee> updateEmployeePassword(@PathVariable UUID id, @RequestParam String newPassword) {
